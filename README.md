# Unit-Testing_MethodsWithArrays-Exercise
...
You can run all tests either from Visual Studio or the .NET CLI.
...
If you have the .NET SDK installed, open a terminal in the project root and run the command: dotnet test
